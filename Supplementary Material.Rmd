...
A series of chi-square tests were conducted to test for statistical differences within and between married and cohabiting respondents.  
The tables show unweighted and weighted frequencies to provide information about the cell sizes. The chi-square tests use the survey weight, accounting for the oversampling in the recruitment of respondents for the survey.  
...
waffle_svy %>%
  ...
  modify_caption("**Chi-square tests within marital groups** <br>unweighted n [weighted n]") %>%
  modify_header(label = "**Variable**")  
...
htest_svy %>%
  ...
  modify_caption("**Chi-square tests within demographic group by marital status** <br>unweighted n [weighted n]") %>%
  modify_header(label = "**Variable**")  
...
The bivariate statistics used in the figure were constructed using the survey-provided variable (WEIGHT_MAINRESPONDENT) to correct for over- or under-sampling of specific target populations. 
