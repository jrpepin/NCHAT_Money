...
The tables show unweighted frequencies to provide information about the cell sizes. The chi-square tests are weighted, accounting for the oversampling in the recruitment of respondents for the survey.  
...
Full replication code for data access, variable construction, and data visualization creation is available in the [github repository](https://github.com/jrpepin/NCHAT_Money/blob/master/data_viz_script.R).  