...
Replication code for data access, variable construction, and data visualization creation is available in the [github repository](https://github.com/jrpepin/NCHAT_Money/blob/master/data_viz_script.R).  